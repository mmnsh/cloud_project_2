"""
Django settings for airpor_reports_ns project.
...
MIDDLEWARE = [
    ...
    "airpor_reports_ns.middlewares.LoggerMiddleware",

]

ROOT_URLCONF = 'airpor_reports_ns.urls'
...
WSGI_APPLICATION = 'airpor_reports_ns.wsgi.application'
...
FLUENTD_HOST = os.getenv('FLUENTD_SERVER') or 'fluentd_reports'
